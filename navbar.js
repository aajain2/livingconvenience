...
(function () {
  ...
  const css = `
    ...
    .navbar-link:hover .pill-bg { opacity: 1; }
    .navbar-logo {
      display: flex; align-items: center; justify-content: center;
    ...
    .nav-dropdown-panel.active > * {
      ...
      animation: dropIn 2s cubic-bezier(0.22, 1, 0.36, 1) forwards;
    }
      ...
      <div class="navbar-shell">
        ...
        <div class="navbar-topbar">
          <div class="navbar-side">
            <a class="navbar-link" data-menu="services" onmouseenter="navOpen('services',this)"><span class="pill-bg"></span>Services</a>
            <a class="navbar-link" href="index.html" onmouseenter="navClose()"><span class="pill-bg"></span>Projects</a>
          </div>
        ...
        <div class="nav-dropdown" id="navDrop">
          <div class="nav-dropdown-panel" id="panel-services">
            <a class="studio-card" href="services.html#network" style="background:transparent;"><img class="studio-card-img" src="assets/service-network.png" alt=""/><div class="studio-card-label"><span class="studio-card-btn light">Network</span></div></a>
            <a class="studio-card" href="services.html#light" style="background:transparent;"><img class="studio-card-img" src="assets/service-lighting.png" alt=""/><div class="studio-card-label"><span class="studio-card-btn light">Light</span></div></a>
            <a class="studio-card" href="services.html#sound" style="background:transparent;"><img class="studio-card-img" src="assets/service-sound.png" alt=""/><div class="studio-card-label"><span class="studio-card-btn light">Sound</span></div></a>
            <a class="studio-card" href="services.html#security" style="background:transparent;"><img class="studio-card-img" src="assets/service-security.png" alt=""/><div class="studio-card-label"><span class="studio-card-btn light">Security</span></div></a>
            <a class="studio-card" href="services.html#climate" style="background:transparent;"><img class="studio-card-img" src="assets/service-climate.png" alt=""/><div class="studio-card-label"><span class="studio-card-btn light">Climate</span></div></a>
            <a class="studio-card" href="services.html#intelligence" style="background:transparent;"><img class="studio-card-img" src="assets/service-intelligence.png" alt=""/><div class="studio-card-label"><span class="studio-card-btn light">Intelligence</span></div></a>
          </div>
        </div>
      </div>
    </nav>
